...
const CropCard = ({
    ...
    <View className="border border-gray-200 bg-white rounded-xl p-4 mb-3 shadow-sm mx-1">
        ...
        <Text className="text-base text-gray-600 mb-1">Temperatura óptima { temp_optimal}</Text>
        <Text className="text-base text-gray-600 mb-1">Temperatura aceptable: {temp_acceptable}</Text>
